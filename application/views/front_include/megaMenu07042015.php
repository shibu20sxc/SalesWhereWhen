                ...
                <ul class="mgmenu"><!-- Begin Mega Menu -->
                    ...
                    <li><span>Shopping Offers</span><!-- Begin Item -->
                        ...
                        <div class="dropdown_container dropdown_5columns"><!-- Begin Item Container -->
                            ...
                            <div class="col_6">
                                <div class="top_part">
                                    <img src="<?php echo base_url() . '/assets/frontend/'; ?>images/grocery_ico.png" alt="Grocery" class="img-responsive" /><a href="<?php echo base_url('grocery/offers'); ?>" class="near_by_deals_grocery">Grocery Shopping</a>
                                </div>
                            </div>
                            <div class="col_6">
                                <div class="top_part">
                                    <img src="<?php echo base_url() . '/assets/frontend/'; ?>images/coupon_ico.png" alt="Coupon" class="img-responsive" /><a href="<?php echo base_url('home/onlineCouponsOffers'); ?>" class="near_by_deals_coupons">Online Coupons</a>
                                </div>
                            </div>
