                ...
                <div class="col-lg-12">
                    <div class="body_product_wrap" id="search_result_container">
                        ...
                        <div class="col-lg-12 less_pad"><!-- first_row-->
                            ...
                            <div class="col-lg-12 less_pad" id="pagination_result_container">
                                <?php
                                if (!empty($onlineCoupons)) {
						...
						<?php $actual_link = base_url()."home/productDetails/".$deal->id; ?>
                                                ...
                                                <div class="social">
                                                    ...
                                                    <a href="#"  data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" onclick="return sendSubscription('<?php echo $actual_link; ?>','<?php echo $image_link; ?>','<?php echo $deal->id; ?>');" class=" newtooltip_msg">
                                ...
                                <div class="col-lg-12">
                                    <nav>
                                        ...
                                        <input type = "hidden" id = "page_count" value = "<?php echo ($page) ? $page : ''; ?>">
                                            <input type = "hidden" id = "category" value = "<?php if(!isset($categoryDetails)){ echo ($categoryDetails->id) ? $categoryDetails->id : ''; }  ?>"/>
